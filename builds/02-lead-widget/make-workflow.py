...
# Системный промпт.
#
# ПОРЯДОК И КОЛИЧЕСТВО ПОВТОРОВ ЗДЕСЬ ВАЖНЕЕ ФОРМУЛИРОВОК. yandexgpt-lite при
# противоречии выбирает то правило, которое сказано раньше и чаще, а не то,
# которое сказано убедительнее. Проверено трижды на живых прогонах:
...
#   3. список «что выяснить» состоял из четырёх пунктов, а «после двух уже можно
#      считать» шло припиской — модель работала список и не вызывала расчёт.
#
